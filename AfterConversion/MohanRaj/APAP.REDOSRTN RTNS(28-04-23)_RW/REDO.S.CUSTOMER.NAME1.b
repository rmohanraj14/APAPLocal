* @ValidationCode : MjozMzY5OTA3MTY6Q3AxMjUyOjE2ODI2NzcwODIyOTc6OTE2Mzg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 28 Apr 2023 15:48:02
...
*06-04-2023      Mohanraj R          R22 Manual code conversion   SM TO @SM,FM TO @FM,VM TO @VM-Call Method Format Modified.
...
*********
    ...
    LRF.APP = "CUSTOMER":@FM:"TELLER":@FM:"TELLER.TRANSACTION":@FM:"T24.FUND.SERVICES":@FM:"FT.TXN.TYPE.CONDITION" ;*R22 Manual code conversion
    LRF.FIELD     = "L.CU.CIDENT":@VM:"L.CU.RNC":@VM:"L.CU.RES.SECTOR":@VM:"L.CU.TEL.TYPE":@VM:"L.CU.TEL.NO":@VM:"L.CU.TIPO.CL":@VM:"L.CU.TEL.AREA":@VM:"L.CU.URB.ENS.RE":@VM:"L.APAP.INDUSTRY":@VM:"L.CUS.PEP":@VM:"L.CU.PASS.NAT" ;*R22 Manual code conversion
    LRF.FIELD<-1> = "L.TT.CLIENT.COD":@VM:"L.TT.CR.ACCT.NO":@VM:"L.ACTUAL.VERSIO":@VM:"L.COMMENTS":@VM:"L.DEBIT.AMOUNT" ;*R22 Manual code conversion
...
**********************
    ...
    Y.TRANSACTION.CNT = DCOUNT(Y.TRANSACTION.CODE,@VM) ;*R22 Manual code conversion
    Y.VAR1=1
    LOOP
...
*****************
    ...
    Y.CNT.CATEG = DCOUNT(Y.CATEG.FROM,@SM) ;*R22 Manual code conversion
    Y.CATEG = 1
    LOOP
...
*    VAR.ADD4 = R.CUSTOMER<EB.CUS.ADDRESS,4>
    ...
    IF VAR.CUS.PEP THEN
        ...
        CALL APAP.REDO.EB.REDO.EB.LOOKUP.LIST(Y.LOOKUP.ID,Y.LOOKUP.VAL,Y.DESC.VAL,RES1,RES2) ;*R22 Manual code conversion
