* @ValidationCode : MjotNDcwMzg2NzMxOkNwMTI1MjoxNjgxMTI1MDQ0Nzc1OjkxNjM4Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 10 Apr 2023 16:40:44
...
SUBROUTINE REDO.S.GET.CUS.ACC.NAME(CUSTOMER.NAME)
*---------------------------------------------------------------------------------
...
*10-04-2023      conversion tool     R22 Auto code conversion     = TO EQ, ++ TO +=1
...
*----------------------------------------------------------------------------------
    ...
    END
    Y.CUS.NAMES = FMT(Y.CUS.NAMES,'L#35')
...
*          END
            ...
            Y.CUS.COMPL.NAME = FMT(Y.CUS.COMPL.NAME,'R#43')
            CUSTOMER.NAME<-1>= Y.CUS.COMPL.NAME
