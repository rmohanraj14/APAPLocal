* @ValidationCode : MjotMTQzODUxNzI4NjpDcDEyNTI6MTY4MjY2MDExMDA3MTo5MTYzODotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 28 Apr 2023 11:05:10
...
*************
    ...
    T.TOT.STMT.CNT=DCOUNT(Y.ID.LIST,@FM) ;*R22 Manual code conversion
    Y.CUR.STMT.NO=1
    LOOP
