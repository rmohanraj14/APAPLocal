* @ValidationCode : MjoxODI0NDc3MzA2OkNwMTI1MjoxNjg1NTMzMzQ1MTQ0OjkxNjM4Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 17:12:25
...
** 30-03-2023       Conversion Tool                 R22 Auto Conversion            FM TO @FM, VM to @VM, SM to @SM
** 30-03-2023           Skanda                      R22 Manual Conversion          CALL method format changed
*********************************************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
***********************
    ...
    R.AMT.CONDITION = ''
    ERR.AMT.MSG     = ''
    APAP.AA.redoCrrGetConditions(ARR.AMT.ID,EFF.AMT.DATE,PROP.AMT.CLASS,PROPERTY.AMT,R.AMT.CONDITION,ERR.AMT.MSG);* R22 Manual conversion
...
*********************
    ...
    WHILE SEL.AA.ID:Y.AA.POS
        ...
        APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.AA.ARR.ACCOUNT,ERR.MSG);* R22 Manual conversion
