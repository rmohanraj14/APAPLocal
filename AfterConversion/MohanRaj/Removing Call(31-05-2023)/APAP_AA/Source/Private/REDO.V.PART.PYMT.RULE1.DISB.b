* @ValidationCode : MjotMTA0MjMzMDk5NzpDcDEyNTI6MTY4NTUzMzczMDM0OTo5MTYzODotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 31 May 2023 17:18:50
...
$PACKAGE APAP.AA
SUBROUTINE REDO.V.PART.PYMT.RULE1.DISB
...
*11-JUL-2011     Bharath G              PACS00080530          Initial Creation
* 29/03/2023         Conversion Tool      AUTO R22 CODE CONVERSTION      VAR2++ to VAR2 += 1, VM to @VM, SM to @SM,FM to @FM, VAR2++ to VAR2 += 1
...
PROCESS:
    ...
    IF APPLICATION EQ 'TELLER' THEN
        GOSUB TT.PROCESS
        APAP.REDOVER.redoVDefTtLoanStatusCond();* R22 Manual conversion
    END
    IF APPLICATION EQ 'FUNDS.TRANSFER' THEN
        GOSUB FT.PROCESS
        CALL REDO.V.FT.LN.STATUS.COND.DISB
    END
RETURN
