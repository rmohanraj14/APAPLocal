* @ValidationCode : MjotNTcwMzA5MTI6Q3AxMjUyOjE2ODU1MzM5NTE2MTM6OTE2Mzg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 31 May 2023 17:22:31
...
* 29/03/2023         Conversion Tool      AUTO R22 CODE CONVERSION       FM TO @FM,SM TO@SM,VM TO @VM
...
GET.OUTS.PRIN:
    ...
    Y.ACCOUNT.PROPERTY = ''
    OUT.ERR = ''
    APAP.TAM.redoGetPropertyName(Y.AA.ID,'ACCOUNT',R.OUT.AA.RECORD,Y.ACCOUNT.PROPERTY,OUT.ERR);* R22 Manual conversion
